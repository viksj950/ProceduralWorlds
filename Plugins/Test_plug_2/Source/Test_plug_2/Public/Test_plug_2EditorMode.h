...
#include "Test_plug_2EditorMode.generated.h"
 ...
 */
UCLASS()
class UTest_plug_2EditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_Test_plug_2EditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UTest_plug_2EditorMode();
	virtual ~UTest_plug_2EditorMode();
