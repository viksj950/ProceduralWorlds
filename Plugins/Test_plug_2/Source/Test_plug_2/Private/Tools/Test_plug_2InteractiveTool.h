...
#include "Test_plug_2InteractiveTool.generated.h"


/**
 * Builder for UTest_plug_2InteractiveTool
 */
UCLASS()
class TEST_PLUG_2_API UTest_plug_2InteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UTest_plug_2InteractiveTool
 */
UCLASS(Transient)
class TEST_PLUG_2_API UTest_plug_2InteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UTest_plug_2InteractiveToolProperties();
...
/**
 * UTest_plug_2InteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class TEST_PLUG_2_API UTest_plug_2InteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UTest_plug_2InteractiveToolProperties> Properties;
